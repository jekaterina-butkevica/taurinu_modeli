#!/bin/bash
#SBATCH --job-name=EUPAUR_v0b1		 # Job name
#SBATCH --partition=weakold			 # Partition name
#SBATCH --ntasks=1				 # Number of tasks
#SBATCH --cpus-per-task=1
#SBATCH --mem=35G				 # Kopējā atmiņa
#SBATCH --time=72:00:00			 # Time limit, hrs:min:sec
#SBATCH --output=TestingScripts/JekaterinaButkevica/Papilionoidea/00GrasslandIndex/sdms_EUPAUR_v0b1.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/TestingScripts/JekaterinaButkevica/sdms_EUPAUR_v0b1.R"
